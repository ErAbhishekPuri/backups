...
<section class="problem-about">
    <div class="container">
        ...
        <div class="img-new">
            ...
            <p><?php the_field('whats_your_problem_about_sub-content');?></p>
          ...
          if ($new_query->have_posts()) {
            while($new_query->have_posts()){
              ...
              ?>
                  ...
                  <a class="employ_text" href="<?php the_permalink();?>"><?php the_title();?></a>
                </div>
                  </div>
...
<?php wp_reset_query(); ?>
                ...
                <div class="row">
                  <div class="col-sm-12 text-center">
                        <a href="<?php echo get_term_link( 20 ,'product_cat') ?>" class="form-control documents">VIEW ALL</a>
                     </div>
                </div>
      </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="col-sm-12">
               ...
               <div class="order-img text-center">
                ...
                <p><?php the_field('employment_updates_sub_heading');?></p>
        </div>
</div>
            <div class="row">


<?php  $args = array( 'post_type' => 'employment_news', 'posts_per_page' => 3 );
          $new_query = new WP_Query( $args ); 
            ...
            <div class="col-md-4 col-sm-6 col-xs-6">
                <div class="employe-wrap">
                    ...
                    <div class="employe-pop-hover">
                        <h2><?php the_title();?></h2>
                         <p><?php the_excerpt();?></p>
                         <a href="<?php the_permalink(225);?>">Read More >></a>
                         <span><?php the_field('news_category')?> | <?php echo get_the_date( 'M d,Y' ); ?></span>
                    </div>
                </div>
            </div>
  ...
  <a class="right carousel-control" href="#ebook-carousel" data-slide="next">
    ...
    <span class="sr-only"></span>
                ...
                <div class="col-sm-7">
                    ...
                    <p><?php the_field('download_our_ebooks_today!_content');?></p>
        ...
        <div class="container">
            ...
            <div class="col-sm-10 col-sm-offset-1">
               ...
               <div class="order-img text-center">
                ...
                <p><?php the_field('newsletter_sign_up_sub-heading');?></p>
                <!-- <form> -->
                <div class="row">
                    <!-- <div class="col-sm-6">
