...
<body>
	...
	<form action="" method="" class="formToValidate">
		<div class="form-group" style="text-align: center;">
			<label class="sol-label" class="sol-label">In the Employment Tribunal</label>
			<input type="text" name="emp_tri">
		</div>
		
		<div class="form-group" style="text-align: right;">
			<label class="sol-label" class="sol-label">Case No:</label>
		...
		<div class="form-group">
			...
			<div style="text-align: center;">
			    ...
			    <input type="text" name="Respondent" placeholder="Respondent"><label class="sol-label Claimant" style="text-align: right">Respondent</label><button class="addmore">Add More</button>
