...
<?php endif; ?>
                   ...
                   <a href="<?php   the_permalink(587);?>" class="btn form-control">
                       Advice now 
                   </a>
			   </div>
               </div>
...
<script type="text/javascript">
     ...
     $('#claiments').html($('#claimant').val());
     $('#resp').html($('#Respondent1').val());
     $('#resp2').html($('#Respondent2').val());
  ...
  <script type="text/javascript">
    ...
    $(".seladv").change(function(){

        var selected = $('.seladv option:selected').val()
